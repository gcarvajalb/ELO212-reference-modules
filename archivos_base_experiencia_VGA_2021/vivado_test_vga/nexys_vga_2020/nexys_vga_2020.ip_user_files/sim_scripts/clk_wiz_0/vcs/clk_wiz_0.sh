...
#
# Generated by Vivado on Sat Jul 25 17:31:25 -04 2020
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"/opt/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../../nexys_vga_2020.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../nexys_vga_2020.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/mauricio/Ramos/Elo212/prueba_vga/nexys_vga_2020/nexys_vga_2020.cache/compile_simlib/vcs"
  fi
